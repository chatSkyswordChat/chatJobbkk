...
searchUrgents.forEach((searchUrgent) => {
    searchResumeUrgent += `<div class="borderStyle borderRadiusStyle p-3 resumeUrgent">`
    searchResumeUrgent += `<a href="javascript:void(0)" onclick="link()">`
    searchResumeUrgent += `<div class="flexPicResume mb-2">`
    searchResumeUrgent += `<figure><img src="${searchUrgent.img}" alt=""></figure>`
    searchResumeUrgent += `<div>
                                <h6><span class="font-weight-bold">ตำแหน่งงานที่สมัคร :</span> <span
                                    class="textRed">${searchUrgent.position}</span></h6>
                                    <div>
    ...
    searchResumeUrgent += `<div class="mb-2">
    ...
    searchResumeUrgent += `<div class="gridArea mb-2">
                                ...
                                <div class="progress">
                                    <div class="progress-bar clGreen" role="progressbar"
                                        style="width: ${searchUrgent.scoreWidth};" aria-valuenow="25" aria-valuemin="0"
                                            aria-valuemax="100">${searchUrgent.scoreWidth}</div>
                                </div>
                            </div>
                        </div>`
...
listUrgents.forEach((listUrgent) => {
    ...
    searchResumeUrgent += `<div class="flexPicResume between mb-2">
            ...
            <div>
                ...
                <div class="progress">
                    <div class="progress-bar clGreen" role="progressbar"
                        ...
                        aria-valuemax="100">${listUrgent.scoreWidth}</div>
                </div>
            </div>
        </div>
        ...
        <div class="growFlex">
            ...
            <div class="saveWork">
                <button class="active saveHeart" data-toggle="tooltip"
                    data-placement="bottom" title="บันทึกประวัติไว้ดูภายหลัง">
...
searchResumeUrgent += `<div class="popUpUrgent mb-3">
                                        ...
                                        <a href="javascript:void(0)" onclick="link()" class="clGreen modalUrgent mb-2">
...
searchResumeUrgent += `<ul>`
let tags = [
    'งานด่วน', 'ท่องเที่ยว/โรงเเรม', 'ราชการ/บริการสาธารณะ', 'งานขาย', 'พาร์ทไทม์'
]
