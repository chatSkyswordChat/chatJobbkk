var profile = ''
profile += `<article class="clWhite borderRadiusStyle p-3 mb-3">
                                    <div class="flexDataCompany mb-3">
                                        <h6 class="fontSubHead">ข้อมูลบริษัท</h6>
                                        <div class="create"><a href="javascript:void(0)">สร้างข้อมูล/แก้ไข</a href="javascript:void(0)"></div>
                                    </div>
                                    ...
                                    <div class="doProfile text-center"><a href="javascript:void(0)">ดูโปรไฟล์</a></div>
                                </article>`
