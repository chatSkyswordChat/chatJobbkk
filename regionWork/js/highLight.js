...
<section class="mb-5">
  <div class="flexHead mb-4">
    <h2 class="fontHead">Job Fair</h2>
    <div class="read"><a href="" target="_blank">อ่านทั้งหมด</a></div>
  </div>

  <ul class="gridJobfair">
    <li>
        <a href="" target="_blank">
            <figure><img src="images/jobfair.gif" alt="" /></figure>
        </a>
    </li>
...
<section class="mb-5">
  <div class="flexHead mb-4">
    <h2 class="fontHead">Job Fair Event</h2>
    <div class="read"><a href="" target="_blank">อ่านทั้งหมด</a></div>
  </div>

  <h6 class="mb-2 font-weight-bold">2021 / กันยายน</h6>
...
<section class="mb-5">
  <div class="flexHead mb-4">
    <h2 class="fontHead">กิจกรรม</h2>
    <div class="read"><a href="${path}article/activity.html" target="_blank">อ่านทั้งหมด</a></div>
  </div>
